...
async def test_two_mower(mock_automower_client_two_mowers: AbstractAuth) -> None:
    ...
    msg = WSMessage(WSMsgType.TEXT, load_fixture("status_event_other_mower.json"), None)
    ...
    msg = WSMessage(WSMsgType.TEXT, load_fixture("status_event_battery_50.json"), None)
    automower_api._handle_text_message(msg)  # pylint: disable=protected-access
